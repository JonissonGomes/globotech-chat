...
fetch("https://run.mocky.io/v3/55e3f9c9-df86-46c9-941a-ea43a7595e19")
  ...
  document.querySelector(".form__container").addEventListener("click", sendMessage);

function sendMessage() {
  let myMessage = document.querySelector(".form__input").value

  containerEl.insertAdjacentHTML("beforeend", `
  <div class="chat-message__container radius__4">
        <p class="chat-message__user">Eu</p>
        <div class="chat-message__content__container">
          <p class="chat-message__text">${myMessage}</p>
          <p class="chat-message__hour">12:52</p>
        </div>
      </div>
  `)
